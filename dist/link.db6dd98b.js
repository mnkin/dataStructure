...
var removeFromList = function removeFromList(list, node) {
  // debugger;
  var x = list;
  var p = node; //当前传入的节点是list的第几个节点，如果不是第一个，就往下找
  //如果x不在list中，x可能为null
...
var getIndex = function getIndex(list, node) {
  var x = list;
  var index = 0;
...
var node4 = appendList(list, 40); // console.log("list");
// console.log(list);

var newList = removeFromList(list, node);
console.log(newList); // console.log("node2");
// console.log(node2);
...
},{}]},{},["../../../.config/yarn/global/node_modules/parcel/src/builtins/hmr-runtime.js","link.js"], null)
//# sourceMappingURL=/link.db6dd98b.js.map